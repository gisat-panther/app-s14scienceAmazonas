    ...
    render() {
        return (
            <div className="s14scienceAmazonas-page">
                ...
                i) Develop, test and validate an operational-level Multi-temporal forest Change Detection (MCD) algorithm,

                ii) Estimate carbon loss and gain from anthropogenic and natural land use changes (LUC) in the Amazonas based on the MCD outputs, and

                iii) Perform scientific analysis and interpretation of the quantified carbon gain/loss, accounting for seasonal stressors such as severe droughts or fires.
                ...
                <h2 id="partners">MEET OUR TEAM</h2>
                ...
                Mato grosso: Ecosystem destruction in the Xingú river basin
                ...
                <h2 id="news">NEWS</h2>
                The progress of Sentinel-1 for Science Amazonas, the release of new datasets and publications will be announced here during the course of the project.

                <h2 id="contact">CONTACT US</h2>

                The S14Science Amazonas project consortium is lead by GISAT s.r.o.:
                Project coordinator: Dr. Neha Joshi
                GISAT s.r.o., Milady Horakove 57, 170 00 Praha 7, Czech Republic
                (+420) 270-003-735
                www.gisat.cz
